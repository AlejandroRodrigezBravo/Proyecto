package com.arodriguezbravo.catalago.view.pdf;
...
public class FacturaPdfView extends AbstractPdfView {
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		tabla2.addCell(mensajes.getMessage("text.cliente.factura.fecha") + ": " + factura.getFechaCreacion());
		...
		for(ItemFactura item: factura.getDetalles()) {
	    ...
	    tabla3.addCell(cell);
	    tabla3.addCell(factura.getNumero());
